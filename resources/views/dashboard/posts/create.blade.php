...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Tambah Data Calon Siswa</h1>
</div>
...
<div class="col-lg-8">
    ...
    <main class="form-registration">
        <form action="/dashboard/posts" method="post" enctype="multipart/form-data">
            @csrf
            <h1 class="h3 mb-3 fw-normal mt-4">Registrasi</h1>
            ...
            <label for="gender" class="form-floating mb-1 mt-3">Jenis Kelamin :</label><br>
            ...
            <div class="form-group mb-3">
                ...
                <input type="file" name="foto" class="form-control mt-1 @error('foto')is-invalid @enderror()" id="foto" placeholder="foto" onchange="previewfoto()">
                @error('foto')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror()
            </div>
            <div class="form-group mb-3">
                ...
                <input type="file" name="ijazah" class="form-control mt-1 @error('ijazah')is-invalid @enderror()" id="ijazah" placeholder="ijazah" onchange="previewijazah()">
                @error('ijazah')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror()
            </div>
            <div class="form-group mb-3">
                ...
                <input type="file" name="kk" class="form-control mt-1 @error('kk')is-invalid @enderror()" id="kk" placeholder="kk" onchange="previewkk()">
                @error('kk')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror()
            </div>
            <button class="w-100 btn btn-lg btn-primary mt-3" type="submit">Tambah Data</button>
        </form>
        <small class="d-block mt-3 mb-4">Back? <a href="/dashboard/posts">Kik Disini!</a></small>
    </main>
    <script>
